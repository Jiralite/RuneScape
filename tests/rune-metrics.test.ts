...
describe("standardiseProfileActivityLog", () => {
	...
	test("Preserves full stop in details that already end with one.", () => {
		const input =
	...
	test("Removes double spaces and preserves full stop.", () => {
	...
	test("Removes double spaces in text and preserves full stop.", () => {
	...
	test("Adds full stop to string without punctuation.", () => {
		const input = "I found an Armadyl hilt";
		const expected = "I found an Armadyl hilt.";
		expect(standardiseProfileActivityLog(input)).toBe(expected);
	});

	test("Preserves full stop for multiple Kree'arra kills.", () => {
	...
	test("Preserves full stop in Dagannoth Kings kill message.", () => {
	...
	test("Preserves full stop for many Dagannoth Kings.", () => {
	...
	test("Handles complex details with double spaces and long description.", () => {
		const input =
	...
	test("Handles details with article in description.", () => {
	...
	test("Handles ancient wyrm detailed description.", () => {
	...
	test("Handles complex kill message with additional context.", () => {
		const input =
	...
	test("Preserves full stop in crystal triskelion fragment find.", () => {
	...
	test("Preserves full stop in pet find message.", () => {
	...
	test("Preserves full stop in Crafting skill level-up details.", () => {
	...
	test("Preserves full stop in Woodcutting skill level-up details.", () => {
	...
	test("Preserves full stop in Smithing skill level-up details.", () => {
	...
	test("Preserves full stop in Giant Arch-Glacor kills.", () => {
	...
	test("Preserves full stop in Magister kill details.", () => {
	...
	test("Adds full stop to Eclipse of the Heart quest completion.", () => {
		const input = "Quest complete: Eclipse of the Heart";
		const expected = "Quest complete: Eclipse of the Heart.";
		expect(standardiseProfileActivityLog(input)).toBe(expected);
	});

	test("Preserves full stop in Eclipse of the Heart quest details.", () => {
		const input =
	...
	test("Preserves full stop in multiple skeletal horror kills.", () => {
	...
	test("Preserves full stop in dragon helm drop details.", () => {
	...
	test("Adds full stop to easy treasure trail completion.", () => {
		const input = "Easy treasure trail completed";
		const expected = "Easy treasure trail completed.";
		expect(standardiseProfileActivityLog(input)).toBe(expected);
	});

	test("Preserves full stop in easy treasure trail details with flared trousers.", () => {
	...
	test("Preserves full stop in easy treasure trail details with wizard robe.", () => {
	...
	test("Preserves full stop in easy treasure trail details with wizard hat.", () => {
	...
	test("Adds full stop to medium treasure trail completion.", () => {
		const input = "Medium treasure trail completed";
		const expected = "Medium treasure trail completed.";
		expect(standardiseProfileActivityLog(input)).toBe(expected);
	});

	test("Preserves full stop in medium treasure trail details with ranger boots.", () => {
	...
	test("Preserves full stop in medium treasure trail details with cat mask.", () => {
